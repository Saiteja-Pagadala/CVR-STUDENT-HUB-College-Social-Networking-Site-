...
-->
                        ...
                        <div class="collapse navbar-toggleable-sm" id="tmNavbar">
                            <ul class="nav navbar-nav">
                               <!-- <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a href="agentsalesipay.jsp" class="nav-link">Installment Pay</a>
                                </li>
                                <li class="nav-item active">
                                    <a href="#agentreport.jsp" class="nav-link">Immediate Payment</a>
                                </li>
                                <li class="nav-item">
 ...
 <div class="tm-home-img-container">
			...
			<form action="agentsalesbook1.jsp" method="post" style="padding-top: 40px;">
			<table cellspacing="" cellpadding="">
			<div><h3>Immediate Payment</h3></div>
			...
			<td style="padding-bottom: 10px;padding-left: 10px;"><input type="text" name="cemail" placeholder="enter customer email" required></td>
			</tr>
			</div>
			<div>
			<tr>
			<th><label>Net Amount</label></th>
			<td style="padding-bottom: 10px;padding-left: 10px;"><input type="text" name="net" placeholder="enter net amount" required></td>
			</tr>
			</div>
			<div>
			<tr>
