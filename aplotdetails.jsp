...
-->
    ...
    <body>
                    ...
                    <nav class="navbar tm-main-nav" style="padding-left: 0px;padding-right: 0px;">
                        ...
                        <div class="collapse navbar-toggleable-sm" id="tmNavbar">
                            <ul class="nav navbar-nav">
                                ...
                                <li class="nav-item">
                                    <a href="aplotsolddetails.jsp" class="nav-link">Sold Products</a>
                                </li>
                                <li class="nav-item">
                                    <a href="aplotvacantdetails.jsp" class="nav-link">Products</a>
                                </li>
                                
                                <li class="nav-item">
                                    <a href="aoptions.jsp" class="nav-link">Back</a>
                                </li>
                            </ul>                        
                        </div>
       ...
       <div class="tm-home-img-container">
			...
			<!--<center>
			<section>
			<form action="alogincheck.jsp" method="post" style="padding-top: 120px;">
			<table cellspacing="" cellpadding="">
			<div><h3>Admin Login</h3></div>
			<div>
			<tr>
			<th><label>Name</label></th>
			<td style="padding-bottom: 10px;padding-left: 10px;"><input type="text" name="aname" placeholder="enter name" required></td>
			</tr>
			</div>
			<div>
			<tr>
