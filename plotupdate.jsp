                        ...
                        <div class="collapse navbar-toggleable-sm" id="tmNavbar">
                            <ul class="nav navbar-nav">
                               <!-- <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a href="agentupdateplot.jsp" class="nav-link">Back</a>
                                </li>
                            </ul>                        
                        </div>
...
if(rs.next()){
%>
			<form action="plotupdate1.jsp" method="post" style="padding-top: 40px;">
			<table cellspacing="" cellpadding="">
			<div><h3>Update Plot Details</h3></div>
			<div>
			<tr>
			...
			<td style="padding-bottom: 10px;padding-left: 10px;"><input type="text" name="area" value="<%=rs.getString(4)%>" required></td>
			</tr>
			</div>
			<div>
			<tr>
			<th><label>Amount</label></th>
			<td style="padding-bottom: 10px;padding-left: 10px;"><input type="text" name="amount" value="<%=rs.getString(5)%>" required></td>
			</tr>
			</div>
			<div>
			<tr>
			...
			<td style="padding-bottom: 10px;padding-left: 10px;"><input type="text" name="status" value="vacant" required></td>
			</tr>
			</div>
			<div>
