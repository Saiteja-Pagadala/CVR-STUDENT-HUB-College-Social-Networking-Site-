...
String sql="select * from product where agent='"+agent+"' and quantity>0";
...
%>
       <div class="tm-home-img-container">
			...
			{%>
		<tr>
		<td><a style="color:red"  href="agentproductdetails.jsp?id=<%=rs.getString(1)%>"><%=rs.getString(2) %></a></td>
