                    ...
                    <nav class="navbar tm-main-nav">
                        ...
                        <div class="collapse navbar-toggleable-sm" id="tmNavbar">
                            <ul class="nav navbar-nav">
                                ...
                                <li class="nav-item">
                                    <a href="custlogin.jsp" class="nav-link">Back</a>
                                </li>
                            </ul>                        
                        </div>
...
return false
			...
			<center>
			<section>
			<form action="custinsert.jsp" method="post" style="padding-top: 80px;" name="myForm" onsubmit="return validateForm()">
			<table cellspacing="" cellpadding="">
			<div><h3>Buyer Registration</h3></div>
			
			<div>
			<tr>
			<th><label>Name</label></th>
			<td style="padding-bottom: 10px;padding-left: 10px;"><input type="text" name="cname" placeholder="enter name" required></td>
			</tr>
			</div>
			...
			<td style="padding-bottom: 10px;padding-left: 10px;"><input type="email" name="cemail" placeholder="enter email" required></td>
			</tr>
			</div>
			<div>
			<tr>
