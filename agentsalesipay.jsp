...
-->
    ...
    <body>
        ...
        <div class="tm-header">
                            ...
                            <ul class="nav navbar-nav">
                               <!-- <li class="nav-item">
                                ...
                                <li class="nav-item active">
                                    <a href="#agentsalesupdate.jsp" class="nav-link">Installment Pay</a>
                                </li>
                                <li class="nav-item">
                                    <a href="agentsalesbook.jsp" class="nav-link">Immediate Payment</a>
                                </li>
                                <li class="nav-item">
			...
			<form action="agentsalesi1.jsp" method="post" style="padding-top: 40px;">
			<table cellspacing="" cellpadding="">
			<div><h3>Credit Payment</h3></div>
