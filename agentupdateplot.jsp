                        ...
                        <div class="collapse navbar-toggleable-sm" id="tmNavbar">
                            <ul class="nav navbar-nav">
                               <!-- <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a href="agentaddplot.jsp" class="nav-link">Add Plot</a>
                                </li>
                                <li class="nav-item active">
                                    <a href="#plotupdate.jsp" class="nav-link">Update Details</a>
                                </li>
                                <li class="nav-item">
...
String sql="select * from addplot where aemail='"+aemail+"' and status='vacant'";
...
%>
        <div class="tm-home-img-container">
			...
			<td><a href="plotupdate.jsp?id=<%=rs.getString(1)%>">Update</a></td>
			</tr>
			<%}%>
			</table>
			</section></center>
