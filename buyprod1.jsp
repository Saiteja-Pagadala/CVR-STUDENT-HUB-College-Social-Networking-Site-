...
%>
        <div class="tm-home-img-container">
			...
			<center><h2 style="padding-top: 40px;">Select Quantity</h2></center>
			<center>
			<section>
			<form action="buyprod2.jsp" method="get" style="padding-top: 60px;">
			...
			<td style="padding-bottom: 10px;padding-left: 10px;"><input type="number" name="quantity" value="<%=rs.getString(7)%>" readonly> </td>
			</tr>
			</div>
			<div>
			<tr>
			<th><label>Order Quantity</label></th>
			<td style="padding-bottom: 10px;padding-left: 10px;"><input type="number" name="ordquantity" placeholder="" required></td>
			</tr>
			</div>
			<div>
