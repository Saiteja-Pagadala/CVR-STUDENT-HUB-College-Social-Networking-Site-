                        ...
                        <div class="collapse navbar-toggleable-sm" id="tmNavbar">
                            <ul class="nav navbar-nav">
                                <li class="nav-item active">
                                    <a href="#agentrcredit.jsp" class="nav-link">Creditors</a>
                                </li>
                         
                                <li class="nav-item">
                                    <a href="agentrplotdetails.jsp" class="nav-link">Plot Details</a>
                                </li>
								<li class="nav-item">
                                    <a href="agentrpayment.jsp" class="nav-link">Payments</a>
                                </li>
                                <li class="nav-item">
...
String sql="select * from credit where aemail='"+aemail+"'";
