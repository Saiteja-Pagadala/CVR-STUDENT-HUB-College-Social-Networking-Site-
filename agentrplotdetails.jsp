...
-->
    ...
    <body>
                    ...
                    <nav class="navbar tm-main-nav">
                        ...
                        <div class="collapse navbar-toggleable-sm" id="tmNavbar">
                            <ul class="nav navbar-nav">
                                <li class="nav-item">
                                    <a href="agentsolddetails.jsp" class="nav-link">Sold Plots</a>
                                </li>
                                <li class="nav-item">
                                    <a href="agentvacantdetails.jsp" class="nav-link">Vacant Plots</a>
                                </li>
                              
                                <li class="nav-item">
                                    <a href="agentreport.jsp" class="nav-link">Back</a>
                                </li>
                            </ul>                        
                        </div>
        ...
        <div class="tm-home-img-container">
			...
			<!--<center>
			<section>
			<form action="agentlogincheck.jsp" method="post" style="padding-top: 120px;">
			<table cellspacing="" cellpadding="">
			<div><h3>Estate Agent Login</h3></div>
			<div>
			<tr>
			...
			<tr><div><td><h4>Not Registered</h4><a href="agentreg.jsp">Click Here</a></td></div></tr>
			</form>
			</section></center>-->
