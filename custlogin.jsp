...
-->
    ...
    <body>
                        ...
                        <button class="navbar-toggler hidden-md-up" type="button" data-toggle="collapse" data-target="#tmNavbar">
                         ...
                         <div class="collapse navbar-toggleable-sm" id="tmNavbar">
                            <ul class="nav navbar-nav">
                                ...
                                <li class="nav-item">
                                    <a href="agentlogin.jsp" class="nav-link">Seller</a>
                                </li>
                                <li class="nav-item active">
                                    <a href="custlogin.jsp" class="nav-link">Buyer</a>
                                </li>
                            </ul>                        
                        </div>
        ...
        <div class="tm-home-img-container">
			...
			<center>
			<section>
			<form action="custlogincheck.jsp" method="post" style="padding-top: 120px;">
			<table cellspacing="" cellpadding="">
			<div><h3>Buyer Login</h3></div>
			<div>
			<tr>
			<th><label>Email</label></th>
			<td style="padding-bottom: 10px;padding-left: 10px;"><input type="text" name="cemail" placeholder="enter email" required></td>
			</tr>
			</div>
			<div>
			<tr>
			...
			<tr><div><td><h4>Not Registered</h4><a href="custreg.jsp">Click Here</a></td></div></tr>
			</form>
			</section></center>
